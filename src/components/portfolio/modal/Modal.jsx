      ...
      <div className="modal_portfolio ">
        ...
        <div className="modal__content">
          {PortfolioData.filter((item) => item.id === modalId).map((item) => {
            var imageOrYoutubeOrGalley = "";
            if (item.youtube !== "") {
              const youtube = {__html:item.youtube};
                imageOrYoutubeOrGalley = <div className="embed-responsive embed-responsive-16by9">
                  <div className="modal__video embed-responsive-item" dangerouslySetInnerHTML={youtube} />
                </div>;
              } else {
                if(typeof item.gallery === "undefined"){
                  imageOrYoutubeOrGalley = 
                  <figure className="modal__img">
                    <img src={item.image} alt={item.modalDetails[0].client} />
                  </figure>;
                }else{
                  imageOrYoutubeOrGalley = 
                  <figure className="modal__img_full">
                    <Slider {...settings}>
                        {item.gallery.map((image, index) => (
                                          <div key={index}>
                                            <img key={index} src={image} alt={item.modalDetails[0].client} />
                                          </div>
                                        ))}
                    </Slider>
                  </figure>
              ...
              <div key={item.id} data-aos="fade">
               ...
               {imageOrYoutubeOrGalley}
                ...
                <button
                  ...
                  onClick={() => setGetModal(false)}
                >
                  <img src={CloseImg} alt="portfolio close" />
                </button>
              </div>
            );
          })}
